    ...
    return (
        <div className='container p-6 flex justify-center align-center flex-col'>
            ...
            <div className='my-0 mx-auto relative'>
                <div className='my-0 mx-auto relative px-12 py-8 shadow-md rounded-md width-full flex flex-col justify-center items-center lg:block'>
                ...
                <div className='my-0 mx-auto p-8 rounded-md shadow-md'>
                    <Image className='my-0 mx-auto rounded-md' src={imgUrls[imgIndex]} alt="villanyszereles_kep" width='550px' height='550px'/>
                </div>
            </div>
        </div>
    )
